...
<div class="fusion-secondary-header" style="background-color: #FFF">
    <div class="fusion-row">
		...
		<img style="width: 100px; margin-right: 10px" src="/wp-content/themes/hcacademy-child/images/hc-banner-logo.jpg" />
	    </a>
	    <a href="https://harpcolumnmusic.com">
		<img style="width: 100px; margin-right: 10px" src="/wp-content/uploads/2016/06/HCA-logo-web.png" />
	    </a>
	    <a href="/">
		<img style="width: 100px; margin-right: 10px; background-color: #ccc" src="/wp-content/uploads/2016/06/HCA-logo-web.png" />
	    </a>
	</div>
        <?php if ( $content_2 ) : ?>
