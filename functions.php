...
function pmpro_status_widget() {
	...
	$content = 'Your membership expires on ' . date(get_option('date_format'), $level->enddate) . '. <a href="/join">Renew</a> | <a href="/my-account">My Account</a> | <a href="/my-account/customer-logout">Logout</a>';
    else
